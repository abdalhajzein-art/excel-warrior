  ...
  th { background-color: #4CAF50; color: white; }
    ...
    // ============================================================
      ...
      if (format === 'txt' || format === 'text') {
        ...
        newWorksheet.getCell(1, 1).value = 'مستخرج من PDF';
        newWorksheet.getCell(1, 2).value = 'عدد الصفحات';
        newWorksheet.getCell(1, 3).value = pageCount;
        const excelBuffer = await newWorkbook.writeToBuffer();
